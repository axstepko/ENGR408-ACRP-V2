...
\begin{figure}[ht]
  \begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{
      Risk Assessment Matrix of the University Park Airport
      }
      \label{fig:riskMatrix}
      \end{minipage}},rotate=-90,center}
      \includegraphics[scale=.81]{RiskMatrixV1.pdf}%
  \end{adjustbox}
\end{figure}
\FloatBarrier
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=6in]{roadmapV2.jpg}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=4in]{UPSitePicture.jpg}}
